package de.julianweinelt.ubm.qol;
...
public class RenderPlayerSwimming extends RenderLivingBase<AbstractClientPlayer> {
    /** this field is used to indicate the 3-pixel wide arms */
    //private final boolean smallArms; //Unused

    public RenderPlayerSwimming(RenderManager renderManager)
    {
        this(renderManager, false);
    }

    public RenderPlayerSwimming(RenderManager renderManager, boolean useSmallArms)
    {
        super(renderManager, new ModelSwimmingPlayer(0.0F, useSmallArms), 0.5F);
        //this.smallArms = useSmallArms; //Unused
    ...
    {
        ModelSwimmingPlayer modelplayer = this.getMainModel();
