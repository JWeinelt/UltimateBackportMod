...
public class GuiMainMenuNonBlur extends GuiScreen {
    ...
    private void rotateAndBlurSkybox()
    {
        ...
        GlStateManager.glTexParameteri(3553, 10241, 9729); // LINEAR Filter
        GlStateManager.glTexParameteri(3553, 10240, 9729); // LINEAR Filter
        GlStateManager.enableBlend();
        ...
        for (int j = 0; j < 3; ++j) {
            ...
            bufferbuilder.pos(k, l, this.zLevel).tex(0.0F + f1, 1.0D).color(1f, 1f, 1f, f).endVertex();
            bufferbuilder.pos(k, 0, this.zLevel).tex(1.0F + f1, 1.0D).color(1f, 1f, 1f, f).endVertex();
            bufferbuilder.pos(0, 0, this.zLevel).tex(1.0F + f1, 0.0D).color(1f, 1f, 1f, f).endVertex();
            bufferbuilder.pos(0, l, this.zLevel).tex(0.0F + f1, 0.0D).color(1f, 1f, 1f, f).endVertex();
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        //this.splashText = ForgeHooksClient.renderMainMenu(this, this.fontRenderer, this.width, this.height, this.splashText);
