...
public class WorldGenCrimsonTree extends WorldGenAbstractTree {
    ...
    private static final IBlockState LOG = ModBlocks.CRIMSON_STEM.getDefaultState();
    private static final IBlockState LEAVES = Blocks.NETHER_WART_BLOCK.getDefaultState();
    ...
    public boolean generate(World world, Random rand, BlockPos pos) {
        ...
        if (soil.getBlock() != Blocks.NETHERRACK && soil.getBlock() != ModBlocks.CRIMSON_NYLIUM) {
            return false;
        }
