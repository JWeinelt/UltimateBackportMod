...
* ✨ **Modern features** in a stable 1.7.10 environment
...
* 📂 Install using **Minecraft Forge 1.7.10**
...
## 💡 Why UBM?
Minecraft 1.7.10 remains one of the most popular versions for modding. UBM extends its life by backporting beloved features, giving players new reasons to explore, build, and play – without leaving behind the mods they love.
...
* Share 👥 it with friends and servers still using 1.7.10
